...
function inhabitent_scripts() {
  ...
  wp_enqueue_script( 'jquery' );//WordPress enqueues jQuery only when the admin bar is visible, usually only for users who are logged in
	
	wp_enqueue_script('font-awesome', 'https://use.fontawesome.com/993f311164.js',  array(), '4.7.0', false);
